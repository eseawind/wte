...
<div class="container">
	        ...
	        -->
	      	...
	      	<tr>
	      		...
	      		<td style="padding-left: 30px;"> 
	        		...
	        		<a href="login.do?method=forget" style="vertical-align: bottom; padding-left: 20px;">Forgot Password</a>
	        	</td>
	        </tr>
        </table>
     </form>
  ...
  <div style="width: 400px; margin: 0 auto;">
  	<p style="text-align: center; color: #428bca;"><small>${rhs["tipInfo"]?if_exists}</small><small>${rhs["url"]?if_exists}</small></p>
  </div>
