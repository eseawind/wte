...
<html lang="en">
  <head>
    <link href="../../../../common/bootstrap303/css/bootstrap.css" rel="stylesheet">
    </head>
  <body>
    <!-- Fixed navbar -->
    ...
    <div class="container theme-showcase">
      ...
      <div class="jumbotron">
        ...
        <p><a href="#" class="btn btn-default btn-lg" role="button">Learn more &raquo;</a></p>
      </div>
      ...
      <p>
        ...
        <button type="button" class="btn btn-lg btn-default">Primary</button>
      ...
      <p>
        ...
        <button type="button" class="btn btn-sm btn-default">Primary</button>
      ...
      <p>
        ...
        <button type="button" class="btn btn-xs btn-default">Primary</button>
