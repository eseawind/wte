...
<div class="control-group">
	<label class="control-label">
		<#if readonly=="">
		<a href="#"  class="btn btn-default btn-xs" onclick="javascript:add_file_input();"><i class="icon-plus"></i>&nbsp;Add File</a>
		<#else>
		File
		</#if>
	</label>
	<div class="controls" id="file_upload_div_main">
		...
		<div id="file_upload_div"  class="form-group">
	  	...
	  	<#if readonly=="">
	  	<input type="button" class="btn btn-default btn-xs" onclick="_upload_file();" value="Upload"/>
	  	</#if>
	</div>
</div>
