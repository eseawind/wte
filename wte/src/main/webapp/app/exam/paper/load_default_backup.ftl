					...
					<div class="panel-body">
					 <table class="table table-condensed table-bordered table-striped">
						...
						<tr>
							...
							<td><input type="text" <#if rhs.readonly>disabled</#if> id="singlechoicemark" name="paper.singlechoicemark" value="<#if rhs["paper"]?exists >${rhs["paper"].singlechoicemark?if_exists}</#if>" onblur="javascript:counttotalmark();" onKeyUp="this.value=this.value.replace(/[^\.\d]/g,'');if(this.value.split('.').length>2){this.value=this.value.split('.')[0]+'.'+this.value.split('.')[1]}"/></td>
						</tr>
						<tr>
							...
							<td><input type="text" <#if rhs.readonly>disabled</#if> id="multichoicemark" name="paper.multichoicemark" value="<#if rhs["paper"]?exists >${rhs["paper"].multichoicemark?if_exists}</#if>" onblur="javascript:counttotalmark();" onKeyUp="this.value=this.value.replace(/[^\.\d]/g,'');if(this.value.split('.').length>2){this.value=this.value.split('.')[0]+'.'+this.value.split('.')[1]}"/></td>
						</tr>
						<tr>
							...
							<td><input type="text" <#if rhs.readonly>disabled</#if> id="blankmark" name="paper.blankmark" value="<#if rhs["paper"]?exists >${rhs["paper"].blankmark?if_exists}</#if>" onblur="javascript:counttotalmark();" onKeyUp="this.value=this.value.replace(/[^\.\d]/g,'');if(this.value.split('.').length>2){this.value=this.value.split('.')[0]+'.'+this.value.split('.')[1]}"/></td>
						</tr>
						<tr>
							...
							<td><input type="text" <#if rhs.readonly>disabled</#if> id="essaymark" name="paper.essaymark" value="<#if rhs["paper"]?exists >${rhs["paper"].essaymark?if_exists}</#if>" onblur="javascript:counttotalmark();" onKeyUp="this.value=this.value.replace(/[^\.\d]/g,'');if(this.value.split('.').length>2){this.value=this.value.split('.')[0]+'.'+this.value.split('.')[1]}"/></td>
						</tr>
						<tr>
